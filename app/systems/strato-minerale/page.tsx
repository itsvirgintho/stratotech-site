...
export default function StratoMineralePage() {
    ...
    <div className="min-h-screen font-sans px-6 py-12 md:px-16 lg:px-24 text-white">
          ...
          <div>
            ...
            >
              ...
              <div className="h-20 flex items-center mb-8">
                <img
                  src="/systems/StratoMinerale.png"
                  alt="Strato Minerale"
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Strato Minerale is a natural mineral aggregate layer engineered to provide texture, durability, and long‑term surface stability within the StratoTech system. Its carefully graded mineral composition enhances bonding performance while creating a durable architectural surface.
              </p>

              <p className="text-white/70 leading-relaxed">
                Used in walkways, plazas, commercial environments, and architectural surfaces, Strato Minerale delivers a balanced combination of natural appearance, slip resistance, and structural durability across interior and exterior applications.
              </p>
      ...
      <section className="max-w-6xl mx-auto mt-16">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="rounded-2xl border border-white/15 bg-white/5 backdrop-blur-md p-6 transition-transform duration-300 md:hover:scale-110">
            <h3 className="font-semibold mb-3">Natural Mineral Texture</h3>
            <p className="text-sm text-white/70 leading-relaxed">
              Carefully graded mineral aggregates create a natural
              architectural surface with enhanced texture and durability.
            </p>
          </div>

          <div className="rounded-2xl border border-white/15 bg-white/5 backdrop-blur-md p-6 transition-transform duration-300 md:hover:scale-110">
            <h3 className="font-semibold mb-3">Surface Traction</h3>
            <p className="text-sm text-white/70 leading-relaxed">
              Mineral composition helps deliver natural slip resistance
              for walkways, plazas, and exterior architectural surfaces.
            </p>
          </div>

          <div className="rounded-2xl border border-white/15 bg-white/5 backdrop-blur-md p-6 transition-transform duration-300 md:hover:scale-110">
            <h3 className="font-semibold mb-3">Structural Stability</h3>
            <p className="text-sm text-white/70 leading-relaxed">
              Works within the layered StratoTech system to provide
              long‑term durability and performance under heavy use.
            </p>
          </div>
      ...
      {imageOpen && (
        ...
        >
          <Image
            src="/system-diagram.png"
            alt="Strato Minerale Visual Large"
            width={1200}
            height={729}
            sizes="95vw"
            quality={80}
