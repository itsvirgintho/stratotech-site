...
export default function StratoCromaPage() {
          ...
          <div>
            ...
            >
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Strato Croma is a decorative aggregate system engineered to deliver vibrant color, durability, and long‑term visual stability in architectural surface applications. The system integrates seamlessly with high‑performance resin binders to create visually striking finishes for both interior and exterior environments.
              </p>

              <p className="text-white/70 leading-relaxed">
                Strato Croma is commonly used in commercial flooring, hospitality environments, walkways, retail spaces, and themed architectural installations where color consistency, surface traction, and long‑term durability are essential.
              </p>
