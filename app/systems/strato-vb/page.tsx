...
export default function StratoVBPage() {
          ...
          <div>
            ...
            >
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Strato VB is a vertical broadcast system engineered for architectural wall and vertical surface applications. The system delivers strong adhesion, broadcast texture, and long‑term durability while maintaining a refined architectural appearance.
              </p>

              <p className="text-white/70 leading-relaxed">
                Designed for feature walls, architectural facades, and decorative vertical elements, Strato VB integrates seamlessly into the StratoTech layered surface system, providing texture, visual depth, and long‑term performance in demanding environments.
              </p>
