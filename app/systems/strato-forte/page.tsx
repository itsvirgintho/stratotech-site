...
export default function StratoFortePage() {
          ...
          <div>
            ...
            >
              ...
              <p className="text-lg text-white/80 leading-relaxed mb-6">
                Strato Forte is a high‑performance structural resin layer engineered to provide exceptional bonding strength, durability, and load resistance within the StratoTech surface system. It serves as a critical structural component that anchors decorative aggregates and finishing layers to the substrate.
              </p>

              <p className="text-white/70 leading-relaxed">
                Designed for demanding architectural and commercial environments, Strato Forte delivers superior adhesion to properly prepared substrates while supporting the layered StratoTech system. Its formulation ensures long‑term structural stability and performance under heavy use conditions.
              </p>
